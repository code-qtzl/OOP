def main():
    ...
    for i in range(len(dragons)):
        # Get the dragon at the current index 'i'
        dragon = dragons[i]
        
        # Create a list of other dragons excluding the current dragon
        other_dragons = dragons[:i] + dragons[i+1:]
        
        # Make the current dragon breathe fire at coordinates (3, 3)
        # and check if any of the other dragons are hit
